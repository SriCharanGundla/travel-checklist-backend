...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.changeColumn('traveler_contacts', 'email', {
      type: Sequelize.TEXT,
      allowNull: true,
    });
    await queryInterface.changeColumn('traveler_contacts', 'phone', {
      type: Sequelize.TEXT,
      allowNull: true,
    });
    await queryInterface.changeColumn('traveler_contacts', 'passport_number', {
      type: Sequelize.TEXT,
      allowNull: true,
    });
    await queryInterface.changeColumn('traveler_contacts', 'emergency_contact_name', {
      type: Sequelize.TEXT,
      allowNull: true,
    });
    await queryInterface.changeColumn('traveler_contacts', 'emergency_contact_phone', {
      type: Sequelize.TEXT,
      allowNull: true,
    });
